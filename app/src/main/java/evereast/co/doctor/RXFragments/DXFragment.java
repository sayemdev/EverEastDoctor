...
import evereast.co.doctor.databinding.FragmentHOBinding;

public class DXFragment extends Fragment implements SelectSuggestion.SelectCCWithSuggestion {

     public DXFragment() {
        // Required empty public constructor
    }

    FragmentHOBinding binding;
    View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentHOBinding.inflate(getLayoutInflater());
        root = binding.getRoot();
        ccList = new ArrayList<>();

        binding.headingTV.setText("Diagnosis");

        sharedPreferences = root.getContext().getSharedPreferences(AIR_PREFERENCE_HO, MODE_PRIVATE);
        list = sharedPreferences.getString(AIR_PREFERENCE_LIST, "");

        selectedList = new ArrayList<>();

        Log.d(TAG, "onCreateView: HO");
    ...
    public boolean GoNext(){
        try {
            SharedPreferences.Editor editor = root.getContext().getSharedPreferences(AIR_PREFERENCE_DX, MODE_PRIVATE).edit();
    ...
    public void UpdateDXData(ArrayList<String> cList) {
        ccList=new ArrayList<>();
        ccList.addAll(cList);
        ...
        Log.d(TAG, "UpdateHOData: "+ccList.size());
    }

    private static final String TAG = "DXFragment";
}