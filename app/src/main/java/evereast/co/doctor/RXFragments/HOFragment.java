...
public class HOFragment extends Fragment implements SelectSuggestion.SelectCCWithSuggestion {
    ...
    public boolean GoNext(){
        try {
            SharedPreferences.Editor editor = root.getContext().getSharedPreferences(AIR_PREFERENCE_HO, MODE_PRIVATE).edit();
    ...
    public void UpdateHOData(ArrayList<String> cList) {
        ccList=new ArrayList<>();
        ccList.addAll(cList);
    ...
    private static final String TAG = "HOFragment";
}